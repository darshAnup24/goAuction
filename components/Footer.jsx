    ...
    const linkSections = [
        ...
        },
        {
            ...
            links: [
                ...
                { text: "Create Listing", path: '/listings/create', icon: null },
        ...
        },
        {
            ...
            links: [
                ...
                { text: "contact@gocart.com", path: 'mailto:contact@gocart.com', icon: MailIcon },
            ...
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    <div>
                        ...
                        <p className="max-w-[410px] mt-6 text-sm">Welcome to GoCart Auctions, your premier online auction marketplace. Discover unique items, place competitive bids, and win amazing deals. Whether you're buying or selling, join our thriving community of auction enthusiasts today.</p>
